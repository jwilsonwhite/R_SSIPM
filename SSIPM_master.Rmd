...
Sp <- 'SEPU'
meshsize = 100
MCMClen = 20000 # how long are MCMC chains
...
F.sd <- 0.1
obs.error.mean <- log(10) #observation error
obs.error.sd <- 0.1
error.mean = 2 # process error shape
error.sd = 0.025 # process error scale

# P & A
Names <- c(paste0("r",c(1:(dim(fishtotal.sepu)[2]))), paste0("i",c(1:(dim(fishtotal.sepu)[2]))), 'F', "obs.error")
Means <- c(rep(r.mean,dim(fishtotal.sepu)[2]), rep(i.mean,dim(fishtotal.sepu)[2]), F.mean,obs.error.mean)
SDs <- c(rep(r.sd,dim(fishtotal.sepu)[2]), rep(i.sd,dim(fishtotal.sepu)[2]), F.sd,obs.error.sd)
...
# P
Names <- c(paste0("r",c(1:(dim(fishtotal.sepu)[2]))), 'F','obs.error')
Means <- c(rep(r.mean,dim(fishtotal.sepu)[2]), F.mean, obs.error.mean)
SDs <- c(rep(r.sd,dim(fishtotal.sepu)[2]),  F.sd, obs.error.sd)
...
#A
Names <- c( paste0("i",c(1:(dim(fishtotal.sepu)[2]))), 'F','obs.error')
Means <- c( rep(i.mean,dim(fishtotal.sepu)[2]), F.mean, obs.error.mean)
SDs <- c(rep(i.sd,dim(fishtotal.sepu)[2]), F.sd, obs.error.sd)
...
# P & A 
Names.mitigation <- c(paste0("r",c(1:(dim(fishtotal.m.sepu)[2]))), paste0("i",c(1:(dim(fishtotal.m.sepu)[2]))), 'F','obs.error')

Means.mitigation <- c(rep(r.mean,dim(fishtotal.m.sepu)[2]), rep(i.mean,dim(fishtotal.m.sepu)[2]), F.mean, obs.error.mean)

SDs.mitigation <- c(rep(r.sd,dim(fishtotal.m.sepu)[2]), rep(i.sd,dim(fishtotal.m.sepu)[2]), F.sd,obs.error.sd)
...
# P  
Names.mitigation <- c(paste0("r",c(1:(dim(fishtotal.m.sepu)[2]))),  'F','obs.error')

Means.mitigation <- c(rep(r.mean,dim(fishtotal.m.sepu)[2]),  F.mean, obs.error.mean)

SDs.mitigation <- c(rep(r.sd,dim(fishtotal.m.sepu)[2]), F.sd,obs.error.sd)
...
# A 
Names.mitigation <- c( paste0("i",c(1:(dim(fishtotal.m.sepu)[2]))), 'F','obs.error')

Means.mitigation <- c(rep(i.mean,dim(fishtotal.m.sepu)[2]), F.mean, obs.error.mean)

SDs.mitigation <- c( rep(i.sd,dim(fishtotal.m.sepu)[2]), F.sd,obs.error.sd)
...
#!!!!!!!!!!!!!!!! Need to add scenario specific priors
...
Names <- c(paste0("r",c(1:(dim(fishtotal.pacl)[2]))), paste0("i",c(1:(dim(fishtotal.pacl)[2]))), 'F')

Means <- c(rep(r.mean,dim(fishtotal.pacl)[2]), rep(i.mean,dim(fishtotal.pacl)[2]), F.mean)

SDs <- c(rep(r.sd,dim(fishtotal.pacl)[2]), rep(i.sd,dim(fishtotal.pacl)[2]), F.sd)

Type <- c( c(rep("lognormal",dim(fishtotal.pacl)[2]),rep("lognormal",dim(fishtotal.pacl)[2]), "lognormal")) #type for recruitment, immigration, fishing, and process error

Prior.pacl <- list(Names,Means,SDs,Type)
names(Prior.pacl) <- c('Names','Means','SDs','Type')
```

```{r}
# phase 2 priors
Names.mitigation <- c(paste0("r",c(1:(dim(fishtotal.m.pacl)[2]))), paste0("i",c(1:(dim(fishtotal.m.pacl)[2]))), 'F')

Means.mitigation <- c(rep(r.mean,dim(fishtotal.m.pacl)[2]), rep(i.mean,dim(fishtotal.m.pacl)[2]), F.mean)

SDs.mitigation <- c(rep(r.sd,dim(fishtotal.m.pacl)[2]), rep(i.sd,dim(fishtotal.m.pacl)[2]), F.sd)

Type.mitigation <- c( c(rep("lognormal",dim(fishtotal.m.pacl)[2]),rep("lognormal",dim(fishtotal.m.pacl)[2]), "lognormal")) #type for recruitment, immigration, fishing, and process error

Prior.m.pacl <- list(Names.mitigation,Means.mitigation,SDs.mitigation,Type.mitigation)
names(Prior.m.pacl) <- c('Names','Means','SDs','Type')
...
Names <- c(paste0("r",c(1:(dim(fishtotal.pane)[2]))), paste0("i",c(1:(dim(fishtotal.pane)[2]))), 'F')

Means <- c(rep(r.mean,dim(fishtotal.pane)[2]), rep(i.mean,dim(fishtotal.pane)[2]), F.mean)

SDs <- c(rep(r.sd,dim(fishtotal.pane)[2]), rep(i.sd,dim(fishtotal.pane)[2]), F.sd)

Type <- c( c(rep("lognormal",dim(fishtotal.pane)[2]),rep("lognormal",dim(fishtotal.pane)[2]), "lognormal")) #type for recruitment, immigration, fishing, and process error

Prior.pane <- list(Names,Means,SDs,Type)
names(Prior.pane) <- c('Names','Means','SDs','Type')
```

```{r}
# phase 2 priors
Names.mitigation <- c(paste0("r",c(1:(dim(fishtotal.m.pane)[2]))), paste0("i",c(1:(dim(fishtotal.m.pane)[2]))), 'F')

Means.mitigation <- c(rep(r.mean,dim(fishtotal.m.pane)[2]), rep(i.mean,dim(fishtotal.m.pane)[2]), F.mean)

SDs.mitigation <- c(rep(r.sd,dim(fishtotal.m.pane)[2]), rep(i.sd,dim(fishtotal.m.pane)[2]), F.sd)

Type.mitigation <- c( c(rep("lognormal",dim(fishtotal.m.pane)[2]),rep("lognormal",dim(fishtotal.m.pane)[2]), "lognormal")) #type for recruitment, immigration, fishing, and process error

Prior.m.pane <- list(Names.mitigation,Means.mitigation,SDs.mitigation,Type.mitigation)
names(Prior.m.pane) <- c('Names','Means','SDs','Type')
...
# Fit.p.a.sepu.m <- fit.SSIPM.MCMC(fix.param.m.sepu,fishtotal.m.sepu,Prior.p.a.sepu.m,'mc_str_ar_P_A_mitigation.RData', burnin = FALSE)
# Fit.p.sepu.m <- fit.SSIPM.MCMC(fix.param.m.sepu,fishtotal.m.sepu,Prior.p.sepu.m,'mc_str_ar_P_mitigation.RData', burnin = FALSE, ipm.i = FALSE)
# Fit.a.sepu.m <- fit.SSIPM.MCMC(fix.param.m.sepu,fishtotal.m.sepu,Prior.a.sepu.m,'mc_str_ar_A_mitigation.RData', burnin = FALSE, ipm.r = FALSE)
```

### Kelp Bass
```{r}
# Kelp Bass
# Fit.p.a.pacl <- fit.SSIPM.MCMC(fix.param.pacl,fishtotal.pacl,Prior.pacl,'mc_str_ar_P_A_pacl.RData', burnin = FALSE)
# Fit.p.pacl <- fit.SSIPM.MCMC(fix.param.pacl,fishtotal.pacl,Prior.pacl,'mc_str_ar_P_pacl.RData', burnin = FALSE,ipm.i = FALSE)
# Fit.a.pacl <- fit.SSIPM.MCMC(fix.param.pacl,fishtotal.pacl,Prior.pacl,'mc_str_ar_A_pacl.RData', burnin = FALSE,ipm.r = FALSE)
# 
# Fit.p.a.pacl.m <- fit.SSIPM.MCMC(fix.param.m.pacl,fishtotal.m.pacl,Prior.m.pacl,'mc_str_ar_P_A_pacl_mitigation.RData', burnin = FALSE)
# 
# Fit.p.pacl.m <- fit.SSIPM.MCMC(fix.param.m.pacl,fishtotal.m.pacl,Prior.m.pacl,'mc_str_ar_P_pacl_mitigation.RData', burnin = FALSE, ipm.i = FALSE)
# 
# Fit.a.pacl.m <- fit.SSIPM.MCMC(fix.param.m.pacl,fishtotal.m.pacl,Prior.m.pacl,'mc_str_ar_A_pacl_mitigation.RData', burnin = FALSE, ipm.r = FALSE)
```

### Barred Sandbass
```{r}
# Fit.p.a.pane <- fit.SSIPM.MCMC(fix.param.pane,fishtotal.pane,Prior.pane,'mc_str_ar_P_A_pane.RData', burnin = FALSE)
# Fit.p.pane <- fit.SSIPM.MCMC(fix.param.pane,fishtotal.pane,Prior.pane,'mc_str_ar_P_pane.RData', burnin = FALSE,ipm.i = FALSE)
# Fit.a.pane <- fit.SSIPM.MCMC(fix.param.pane,fishtotal.pane,Prior.pane,'mc_str_ar_A_pane.RData', burnin = FALSE,ipm.r = FALSE)
# 
# Fit.p.a.pane.m <- fit.SSIPM.MCMC(fix.param.m.pane,fishtotal.m.pane,Prior.m.pane,'mc_str_ar_P_A_pane_mitigation.RData', burnin = FALSE)
# 
# Fit.p.pane.m <- fit.SSIPM.MCMC(fix.param.m.pane,fishtotal.m.pane,Prior.m.pane,'mc_str_ar_P_pane_mitigation.RData', burnin = FALSE, ipm.i = FALSE)
# 
# Fit.a.pane.m <- fit.SSIPM.MCMC(fix.param.m.pane,fishtotal.m.pane,Prior.m.pane,'mc_str_ar_A_pane_mitigation.RData', burnin = FALSE, ipm.r = FALSE)
```
...
### California Sheepehad
```{r}
ssipm.dic(postproc.MCMC = Post.fit.p.a.sepu)$DIC #1695.934
ssipm.dic(postproc.MCMC = Post.fit.p.sepu)$DIC #2925.95
ssipm.dic(postproc.MCMC = Post.fit.a.sepu)$DIC #1699.18

ssipm.dic(postproc.MCMC = Post.fit.p.a.mitigation)$DIC #999.1803
ssipm.dic(postproc.MCMC = Post.fit.p.mitigation)$DIC #237.5383
ssipm.dic(postproc.MCMC = Post.fit.a.mitigation)$DIC #626.6687
```

### Kelp Bass
```{r}
ssipm.dic(postproc.MCMC = Post.fit.p.a.pacl)$DIC #2068.913
ssipm.dic(postproc.MCMC = Post.fit.p.pacl)$DIC #4983.585
ssipm.dic(postproc.MCMC = Post.fit.a.pacl)$DIC #1414.838

ssipm.dic(postproc.MCMC = Post.fit.p.a.pacl.m)$DIC #924.8508
ssipm.dic(postproc.MCMC = Post.fit.p.pacl.m)$DIC #515.685
ssipm.dic(postproc.MCMC = Post.fit.a.pacl.m)$DIC #-167.9727
```

### Barred Sandbass
```{r}
ssipm.dic(postproc.MCMC = Post.fit.p.a.pane)$DIC #1886.613
ssipm.dic(postproc.MCMC = Post.fit.p.pane)$DIC #5206.86
ssipm.dic(postproc.MCMC = Post.fit.a.pane)$DIC #2775.029

ssipm.dic(postproc.MCMC = Post.fit.p.a.pane.m)$DIC #-226.6451
ssipm.dic(postproc.MCMC = Post.fit.p.pane.m)$DIC #-252.9732
ssipm.dic(postproc.MCMC = Post.fit.a.pane.m)$DIC #67.37176
```
...
posterior.plot <- function(data,post.fit,model,ggtitle){
  ...
  pivot_longer(cols = 1:(ncol(post.fit$Values)-1),
                names_to = "var",
                values_to = "posterior") %>%
  mutate(var = as.factor(var)) %>%
  mutate(var = fct_relevel(var, c(paste0("r",c(1:(dim(data)[2]))), paste0("i",c(1:(dim(data)[2]))), 'F')))
...
f <- data.frame(test %>% select("F")) %>% 
  pivot_longer(cols = "F",names_to = "var",values_to = "posterior") %>% 
  ggplot(aes(x = var, y = posterior))+
  geom_violin( fill = "lavender")+
  # facet_wrap(~var)+
  theme_bw()+
  theme(axis.title.x = element_blank(),axis.text = element_text(size = 15),strip.text = element_text(size = 15))
...
plot <- ggplot()+
  geom_line(data = tfish, aes(x = size, y = density), color = "black", linewidth = 0.3) +
...
posterior.plot(fishtotal.m.sepu, Post.fit.p.mitigation, model = "P", ggtitle = "p.sepu.m")
ggsave("posterior.p.sepu.m.pdf", width = 11, height = 8.5,units = "in",path = here("output","plots"))
...
# Posterior Plot - Best model
posterior.plot(fishtotal.pacl, Post.fit.a.pacl, model = "A", ggtitle = "a.pacl")
ggsave("posterior.a.pacl.pdf", width = 11, height = 8.5,units = "in",path = here("output","plots"))

posterior.plot(fishtotal.m.pacl, Post.fit.a.pacl.m, model = "A", ggtitle = "a.pacl.m")
ggsave("posterior.a.pacl.m.pdf", width = 11, height = 8.5,units = "in",path = here("output","plots"))
...
posterior.plot(fishtotal.m.pane, Post.fit.p.pane.m, model = "P", ggtitle = "p.pame.m")
...
sepu.m <- post.pred.check(Data = fishtotal.m.sepu,fix.param = fix.param.m.sepu, Post.fit = Post.fit.p.mitigation, ipm.burnin = FALSE, ipm.i = FALSE)

#best Kelp bass model
pacl <- post.pred.check(Data = fishtotal.pacl,fix.param = fix.param.pacl, Post.fit = Post.fit.a.pacl, ipm.burnin = FALSE, ipm.r = FALSE)
pacl.m <- post.pred.check(Data = fishtotal.m.pacl, fix.param = fix.param.m.pacl, Post.fit = Post.fit.a.pacl, ipm.burnin = FALSE, ipm.r = FALSE)
...
pane.m <- post.pred.check(Data = fishtotal.m.pane,fix.param = fix.param.m.pane, Post.fit = Post.fit.p.pane.m, ipm.burnin = FALSE, ipm.i = FALSE)
...
songs %>% 
  ...
  geom_col(aes(x = year, y = transect, fill = phase_built_code), position = position_dodge())+
